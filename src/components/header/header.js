                ...
                <nav className='md:flex md:flex-row  flex flex-row w-full justify-between p-0 m-0 md:place-items-start'>
                    ...
                    <div className='hidden md:basis-2/5 md:flex flex-row pl-0 pr-0 w-1/2'>
                        ...
                        <div className='flex w-full flex-row justify-center '>
                            <Link to='/lauch-dao'>
                                <button className='rounded-xl w-full md:w-full hover:scale-110 transition duration-300 ease-in-out h-10 md:px-2 overflow-hidden flex flex-row justify-center'>
