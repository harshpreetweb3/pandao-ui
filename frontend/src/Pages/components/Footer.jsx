...
const Footer = () => {
  return (
    <div className="flex items-center justify-center mx-auto border-t-2  bg-[radial-gradient(ellipse_at_left,_var(--tw-gradient-stops))] from-[#281038] from-0% via-[#181734] via-50%  to-[#0D1E3B] to-100%  border-b-2 border-purple-800 text-white">
