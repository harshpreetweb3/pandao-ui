...
const CommnetImageUpdater = ({ onUploadSuccess }) => {
  ...
  return (
    <div className="flex rounded-none flex-col items-center justify-center gap-2">
      <div className="w-">
        ...
        <label
          htmlFor="fileInput"
          className="flex items-center pl-2 border-2 py-[7px] px-1 border-l-0"
        >
          <Paperclip/>
        </label>
      </div>
...
CommnetImageUpdater.propTypes = {
  onUploadSuccess: PropTypes.func.isRequired,
};

export default CommnetImageUpdater;
